        ...
        <div className=" h-full min-h-screen font-mono subpixel-antialiased bg-fixed bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-gray-700 via-gray-900 to-black">
            <div className="flex flex-col justify-center items-center ">
                ...
                <div className=" xs:w-2/3 px-9 py-9 font-medium tracking-normal leading-relaxed mb-10 bg-white bg-opacity-10 backdrop-blur-2xl rounded-tl-eL rounded-tr-eL rounded-br-eL  drop-shadow-lg">
                    ...
                    <p> &ldquo; Hello, my name is <strong>Yukendhiran</strong> and I am a student at <strong>VIT University</strong>. As a tech enthusiast, I am passionate about learning and exploring new technologies.&ldquo;</p> <br/>    
                    <p> &ldquo; I can design, develop, and administrate, I am proficient in a range of technologies including <strong>JavaScript</strong>, <strong>HTML</strong>, <strong>CSS</strong>, <strong>SQL</strong>, <strong>Java</strong>, <strong>ReactJS</strong>, <strong>NextJs</strong>, and <strong>TailwindCSS</strong>. I have been using <strong>Linux</strong> as my daily driver for the past 3 years.&ldquo;</p> <br/>
                    <p> &ldquo; Currently, I am interested in exploring the exciting and rapidly-evolving world of <strong>WEB3 space</strong> and I am open to work opportunities where I can learn and apply new technologies.&ldquo;</p> <br/>
